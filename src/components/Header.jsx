...
function Header() {
  return (
    <div className="flex max-h-[660px] overflow-hidden rounded-2xl bg-lightGrey bg-contain bg-right bg-no-repeat px-6 py-12 sm:bg-[url('/images/hero.svg')] xl:h-full">
      <div className="justify-left flex items-center sm:max-w-[360px] lg:max-w-[600px] xl:max-w-[780px]">
        <div className="flex flex-col space-y-4 xl:ml-20 xl:space-y-12">
          <div className="text-4xl font-bold text-primary lg:text-7xl">
